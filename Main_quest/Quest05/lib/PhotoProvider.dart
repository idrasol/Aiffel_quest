...
class PhotoProvider with ChangeNotifier {
  ...
  Future<void> fetchRandomImages() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('https://5fef-221-145-193-52.ngrok-free.app/random_images?num_images=10'));
      if (response.statusCode == 200) {
        ...
        for (int i = 0; i < imageUrls.length; i++) {
          ...
          _photos.add(Photo(id: i, url: imageUrls[i], title: 'Image $i', detail: 'Detail for image $i'));
        }
